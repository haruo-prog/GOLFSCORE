...
public class MainActivity extends Activity {
    ...
    private static final int REQ_BACKUP_CREATE = 1401, REQ_RESTORE_OPEN = 1402;
    ...
    private View roundHeader() {
        LinearLayout c = card();
        TextView title = text((currentHole + 1) + "H  PAR" + pars[currentHole], 30, C_TEXT, true);
    ...
    private String buildBackupText() {
        StringBuilder b = new StringBuilder("NK_GOLF_SCORE_BACKUP_V26\n");
    ...
    private void applyBackupText(String raw) throws Exception {
        if (TextUtils.isEmpty(raw) || !(raw.startsWith("NK_GOLF_SCORE_BACKUP_V26") || raw.startsWith("NK_GOLF_SCORE_BACKUP_V25") || raw.startsWith("NK_GOLF_SCORE_BACKUP_V24") || raw.startsWith("NK_GOLF_SCORE_BACKUP_V23"))) throw new Exception("invalid backup");
    ...
    private String es(String k){ switch(k){case"concept":return"La app de golf más rápida. Funciona sin conexión.";case"why":return"¿Por qué elegir esta app?";case"value_points":return"Sin conexión / Sin anuncios / Sin suscripción / Sin cuenta / Menos toques";case"language":return"Idioma";case"round":return"Ronda";case"start_round":return"Iniciar ronda";case"resume_round":return"Continuar ronda";case"history":return"Historial";case"analysis":return"Análisis";case"settings":return"Ajustes / Copia";case"settings_short":return"Ajustes";case"home":return"Inicio";case"score_input":return"Entrada de score";case"save_analysis":return"Guardar y ver análisis";case"cancel":return"Cancelar / Salir";case"back_home":return"Volver al inicio";case"backup":return"Copia / Restaurar";case"backup_save":return"Guardar copia";case"restore_backup":return"Restaurar copia";case"saved":return"Guardado";case"backup_saved":return"Copia guardada";case"restore_done":return"Restaurado";}return en(k);}
    private String fr(String k){ switch(k){case"concept":return"L’app de score golf la plus rapide. Hors ligne.";case"why":return"Pourquoi choisir cette app ?";case"value_points":return"Hors ligne / Sans pub / Sans abonnement / Sans compte / Moins de taps";case"language":return"Langue";case"round":return"Partie";case"start_round":return"Démarrer";case"resume_round":return"Reprendre";case"history":return"Historique";case"analysis":return"Analyse";case"settings":return"Réglages / Sauvegarde";case"settings_short":return"Réglages";case"home":return"Accueil";case"score_input":return"Saisie du score";case"save_analysis":return"Enregistrer et analyser";case"cancel":return"Annuler / Fin";case"back_home":return"Accueil";case"backup":return"Sauvegarde / Restauration";case"backup_save":return"Sauvegarder";case"restore_backup":return"Restaurer";case"saved":return"Enregistré";case"backup_saved":return"Sauvegardé";case"restore_done":return"Restauré";}return en(k);}
    private String ko(String k){ switch(k){case"language":return"언어 선택";case"concept":return"세계에서 가장 빠른 오프라인 골프 스코어 앱";case"start_round":return"라운드 시작";case"history":return"기록";case"analysis":return"분석";case"settings_short":return"설정";case"home":return"홈";case"score_input":return"스코어 입력";case"save_analysis":return"저장하고 분석 보기";case"cancel":return"취소 종료";case"back_home":return"홈으로";case"backup":return"백업 / 복원";case"backup_save":return"백업 저장";case"restore_backup":return"백업에서 복원";case"backup_saved":return"백업 저장 완료";case"restore_done":return"복원 완료";case"saved":return"저장했습니다";}return en(k);}
    private String zh(String k){ switch(k){case"language":return"语言选择";case"concept":return"世界最快的离线高尔夫记分应用";case"start_round":return"开始球局";case"history":return"历史";case"analysis":return"分析";case"settings_short":return"设置";case"home":return"主页";case"score_input":return"成绩输入";case"save_analysis":return"保存并查看分析";case"cancel":return"取消结束";case"back_home":return"返回主页";case"backup":return"备份 / 恢复";case"backup_save":return"保存备份";case"restore_backup":return"从备份恢复";case"backup_saved":return"备份已保存";case"restore_done":return"已恢复";case"saved":return"已保存";}return en(k);}
    private String tw(String k){ switch(k){case"language":return"語言選擇";case"concept":return"全球最快的離線高爾夫計分 App";case"why":return"為什麼選這個 App？";case"value_points":return"離線 / 無廣告 / 無訂閱 / 不需帳號 / 更少點擊";case"start_round":return"開始球局";case"history":return"紀錄";case"analysis":return"分析";case"settings_short":return"設定";case"home":return"首頁";case"score_input":return"成績輸入";case"save_analysis":return"儲存並查看分析";case"cancel":return"取消結束";case"back_home":return"回首頁";case"backup":return"備份 / 還原";case"backup_save":return"儲存備份";case"restore_backup":return"從備份還原";case"backup_saved":return"備份已儲存";case"restore_done":return"已還原";case"saved":return"已儲存";}return en(k);}
    private String de(String k){ switch(k){case"language":return"Sprache";case"concept":return"Die schnellste Offline-Golfscore-App";case"start_round":return"Runde starten";case"history":return"Verlauf";case"analysis":return"Analyse";case"settings_short":return"Einstellungen";case"home":return"Start";case"score_input":return"Score-Eingabe";case"save_analysis":return"Speichern und Analyse";case"cancel":return"Abbrechen / Ende";case"back_home":return"Zur Startseite";case"backup":return"Backup / Wiederherstellen";case"backup_save":return"Backup speichern";case"restore_backup":return"Backup wiederherstellen";case"backup_saved":return"Backup gespeichert";case"restore_done":return"Wiederhergestellt";case"saved":return"Gespeichert";}return en(k);}
